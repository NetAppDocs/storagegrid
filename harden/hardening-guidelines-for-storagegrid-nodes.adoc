...
. In the Change password section, enter a new BMC password between 8 and 32 characters in length in *New password* and then enter it again in *Confirm new password*.
. Select *Save*.
...
You can enable the USB ports on the appliances to allow technical support access for diagnostics and troubleshooting. If you don't need remote USB port access, disable the ports for security.
