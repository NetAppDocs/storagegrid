...
+
If a secure, trusted, internal management network isn't available, leave the BMC management port unconnected or blocked, unless a BMC connection is requested by technical support.
