...
== Control remote access through USB ports
...
** Select the *Enable USB ports* checkbox to enable the ports.
** Clear the *Enable USB ports* checkbox to disable the ports.
