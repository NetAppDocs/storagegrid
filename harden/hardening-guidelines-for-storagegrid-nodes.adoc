...
== Control external USB port access on appliances

You can enable the USB ports on the appliances to allow technical support access for diagnostics and troubleshooting. If you don't need remote USB port access, disable the ports for security. USB ports are enabled by default after the initial install or an upgrade.
...
+
If the USB checkbox was previously unchecked and saved, select the *Enable USB ports* checkbox and reboot the appliance to enable USB ports again.
