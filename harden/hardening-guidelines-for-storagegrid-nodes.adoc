...
For all StorageGRID nodes, you should disable or block access to unused services. For example, if you aren't planning to use DHCP, disable port 68, which is for inbound communication from a DHCP service to all nodes.
