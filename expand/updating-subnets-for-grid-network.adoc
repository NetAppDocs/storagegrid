...
---
= Add or update subnets to the Grid Network for expansion in StorageGRID
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Don't use subnets that contain the following IPv4 addresses for the Grid Network, Admin Network, or Client Network of any node:
...
For example, don't use the following subnet ranges for the Grid Network, Admin Network, or Client Network of any node:
