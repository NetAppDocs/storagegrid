...
---
= Add direct-attached or SAN volumes to Linux Storage Nodes in StorageGRID
:imagesdir: ../media/
...
* You have access to the link:../install-nodes/index.html[instructions for installing StorageGRID] for your Linux platform.
