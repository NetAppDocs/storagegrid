...
---
= Add storage volumes to Linux storage nodes to expand capacity in your StorageGRID system
:imagesdir: ../media/
...
* You have access to the link:../swnodes/index.html[instructions for installing StorageGRID] for your Linux platform.
