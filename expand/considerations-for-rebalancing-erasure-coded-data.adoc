...
* Won't distribute erasure-coded data to Storage Nodes that are more than 80% full.
...
** Larger-capacity nodes will be relatively less full than smaller-capacity nodes, even though all nodes will end up with approximately the same amount of data.
+
