...
---
= Add storage volumes to VMware Storage Nodes in StorageGRID
:icons: font
:imagesdir: ../media/
...
.Before you begin
* You have access to the link:../install-nodes/index.html[instructions for installing StorageGRID for VMware deployments].
