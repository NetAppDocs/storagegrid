...
---
= Configure newly added nodes and sites in StorageGRID
:icons: font
:imagesdir: ../media/
...
.. If single sign-on (SSO) is enabled for your StorageGRID system, create a relying party trust for the new Admin Node. You can't sign in to the node until you create this relying party trust. Refer to set up SSO using link:../admin/learn-about-setting-up-sso-oidc.html[OIDC] or link:../admin/learn-about-setting-up-sso-saml.html[SAML].
