...
---
= Prepare to expand your StorageGRID system
:icons: font
:imagesdir: ../media/
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267[Release Notes^]. You must sign in with your NetApp account or create an account to access the Release Notes.
* link:../swnodes/index.html[Installation instructions for your platform]
...
. If you are expanding a RHEL system, select the appropriate files.
+
