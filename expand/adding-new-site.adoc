...
+
For more information about changing an ILM policy when adding a new site, refer to the link:../ilm/example-6-changing-ilm-policy.html[example for changing an ILM policy].
