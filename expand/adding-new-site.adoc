...
** Do not use erasure coding between sites with a latency greater than 100 ms.
+
** The sites in your StorageGRID system should not span across wide geographical distances, for example, across multiple continents.
