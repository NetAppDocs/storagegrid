...
+
link:https://fieldportal.netapp.com/s/article/TR-4889-NetApp-StorageGRID-Design-and-Implementation-Guidelines-and-Best-Practices[TR-4889: NetApp StorageGRID Design and Implementation Guidelines and Best Practices^] provides specific recommendations for network bandwidth and latency between sites. You need a Field Portal account to access the TR. If you don't have a Field Portal account, contact your NetApp account team.
