...
---
= Guidelines for adding metadata capacity in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:metadata_space_after_expansion.png[Diagram of metadata redistributed after two Storage Nodes added]
