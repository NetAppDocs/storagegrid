...
---
= Deploy new grid nodes in your StorageGRID system
:icons: font
:imagesdir: ../media/
...
. link:../swnodes/deploying-storagegrid-node-as-virtual-machine.html[Deploy the new node as virtual machine] and connect it to one or more StorageGRID networks.
+
...
* You have the instructions for installing StorageGRID for your version of Linux, and you have reviewed the link:../swnodes/index.html[hardware and storage requirements].
