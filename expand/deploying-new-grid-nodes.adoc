...
---
= Deploy new grid nodes in StorageGRID
:icons: font
:imagesdir: ../media/
...
. link:../install-nodes/deploying-storagegrid-node-as-virtual-machine.html[Deploy the new node as virtual machine] and connect it to one or more StorageGRID networks.
+
...
* You have the instructions for installing StorageGRID for your version of Linux, and you have reviewed the link:../install-nodes/index.html[hardware and storage requirements].
