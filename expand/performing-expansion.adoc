...
* You can link:../upgrade/changes-to-grid-management-api.html#new-private-endpoints-for-move-adc[move the ADC service from one Storage Node to another] to ensure the ADC service quorum is met.
