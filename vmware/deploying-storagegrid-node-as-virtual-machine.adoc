...
.. In the *Primary Admin IP* field, enter the IP address of the primary Admin Node, if available, for the Grid Network. If the primary Admin Node isn't available, enter the IP of the non-primary Admin Node you want to use for recovery.
+
