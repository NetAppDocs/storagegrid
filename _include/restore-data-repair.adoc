...
NOTE: You can set the Input-output (I/O) priority for erasure-coded data repair and purge operations. In the Grid Manager, select *SUPPORT* > *I/O prioritization*.
