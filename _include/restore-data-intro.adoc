...
* You have confirmed that the recovered Storage Node has a Connection State of *Connected* image:icon_alert_green_checkmark.png[icon alert green check mark] on the *Nodes* > *Overview* tab in the Grid Manager.
