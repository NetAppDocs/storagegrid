...
If this key is omitted, no temporary password will be set by default. Alternatively, you can set a temporary password using the StorageGRID Installation API or StorageGRID Appliance Installer user interface.
