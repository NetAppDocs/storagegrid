...
[.lead]
You restore object data for a failed storage volume or Storage Node using Grid Manager. You can also use Grid Manager to monitor restoration processes in progress and display a restoration history.
...
After you have replaced the drives and the volumes have been formatted, Grid Manager displays the volumes as candidates for restoration on the *Maintenance* > *Volume restoration* > *Nodes to restore* tab.
...
+
If the recovered Storage Node contains fewer volumes than the node it is replacing, contact technical support for assistance.
