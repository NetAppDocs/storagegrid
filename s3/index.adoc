...
| 11.9
| Added support for pre-calculated SHA256 checksum values for the following requests and supported headers. You can use this feature to verify the integrity of uploaded objects:
...
* ListParts: No associated `x-amz-checksum` header
