...
| 11.9
| Added support for the `x-amz-checksum` response headers for the following object requests:
...
These `x-amz-checksum` headers provide an object's checksum value for the SHA256 protocol.
