...
| 11.9
| Added support for `x-amz-checksum` response headers. These headers provide an object's checksum value for the SHA256 protocol. The following list shows the object request and the supported header:
