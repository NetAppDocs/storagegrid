...
You must specify one of the following request headers in the request:
...
NOTE: StorageGRID doesn't validate the contents of the `x-amz-checksum-` header for these operations.
