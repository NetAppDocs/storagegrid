...
If multiple tenants each have approximately 5,000 buckets, each Storage Node in the grid must have a minimum of 64 GB of RAM.
...
* Enables S3 Object Lock on existing buckets.
