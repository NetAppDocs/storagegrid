...
* StorageGRID supports Amazon Simple Notification Service (Amazon SNS)topics, Kafka topics, or webhook endpoints as destinations. Simple Queue Service (SQS) or Amazon Lambda endpoints aren't supported.
