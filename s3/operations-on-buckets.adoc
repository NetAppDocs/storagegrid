...
+
S3 Object Lock requires bucket versioning, which is enabled automatically when you create the bucket.
+
You can only enable S3 Object Lock after a bucket is created. After S3 Object Lock is enabled, you can't disable it. 
