...
For the HeadObject and ListObject requests, StorageGRID returns the LastModified timestamps with different precision while AWS returns the LastModified timestamps with the same precision. 
