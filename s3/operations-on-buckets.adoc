...
| GetBucketLocation
| Returns the region that was set using the `LocationConstraint` element in the CreateBucket request. If no region was set, the operation returns the default region `us-east-1`.
