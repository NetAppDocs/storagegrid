...
summary: 'The PUT Bucket last access time request allows you to enable or disable last access time updates for individual buckets.'
---
= Enable and disable last access time updates in StorageGRID with PUT Bucket last access time request
:icons: font
:imagesdir: ../media/
