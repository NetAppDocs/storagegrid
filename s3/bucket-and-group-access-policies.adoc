...
| Compares to the `object-lock-mode` expanded from the request header in the PutObject (and CopyObject) request or from the XML body in the PutObjectRetention request.
