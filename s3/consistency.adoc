...
** Allows for site failure tolerance for grids with three or more sites.
** Two-site grids won't have site failure tolerance.
** Those grids will incur cross-site latency for all requests.
** Account usage won't be updated when a site is down.
** GET Bucket consistency and PUT Bucket consistency operations will succeed with one site down.
