...
* `x-amz-checksum-*`
+
NOTE: StorageGRID calculates and stores a checksum that matches the type specified in the Create Multipart Upload request. The supported checksums are CRC-32, CRC-32C, CRC-64NVME, and SHA-256.
