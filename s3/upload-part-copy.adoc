...
* `x-amz-checksum-*`
+
NOTE: StorageGRID calculates and stores a checksum matching the type specified in the Create Multipart Upload request. The supported checksums are CRC32, CRC32C, CRC64NVME, or SHA-256.
