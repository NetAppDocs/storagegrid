...
---
= S3 CreateMultipartUpload request headers and options in StorageGRID
:icons: font
:imagesdir: ../media/
...
+
NOTE: If the CreateMultipartUpload request doesn't specify a checksum, StorageGRID doesn't calculate a default CRC-64/NVME checksum for an object. StorageGRID ignores invalid or unsupported x-amz-checksum-algorithm values.
