...
|12.0
|Added support for cross-origin resource sharing (CORS) for Grid Manager and Tenant Manager. This allows you to view Grid Manager data and use Tenant Manager APIs in other trusted domains. link:../tenant/enable-cross-origin-resource-sharing-cors.html[Learn more].
