...
|12.0
|Added support for cross-origin resource sharing (CORS) for a management interface. This allows another domain to access data in StorageGRID using management APIs. link:../tenant/enable-cross-origin-resource-sharing-cors.html[Learn more].
