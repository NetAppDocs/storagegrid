...
---
= Troubleshoot external syslog server error messages for StorageGRID
:icons: font
:imagesdir: ../media/
...
* link:../monitor/configure-log-management.html[Configure log management and external syslog server]
