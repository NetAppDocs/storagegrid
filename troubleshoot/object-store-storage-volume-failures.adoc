...
---
= Learn about object store failures for storage volumes in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:nodes_page_storage_nodes_storage_tables.png[Nodes Page Storage Node Storage Tables]
