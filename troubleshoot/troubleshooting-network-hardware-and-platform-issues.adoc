...
For more information about using Promiscuous Mode, see the instructions for link:../swnodes/configuring-host-network.html[how to configure the host network].
