...
For more information, see the instructions for link:../install-nodes/configuring-host-network.html[enabling MAC cloning].
...
For more information about using Promiscuous Mode, see the instructions for link:../install-nodes/configuring-host-network.html[how to configure the host network].
