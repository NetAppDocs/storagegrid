...
* link:../monitor/manually-triggering-autosupport-package.html[Manually trigger an AutoSupport package]
...
|===
| image:feature_checkmark.gif[checkmark]
| Item
| Notes
...
| Collect log files and system data for your system. Select *Support* > *Tools* > *Log collection*.
