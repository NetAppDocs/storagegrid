...
| On the Grid Manager dashboard, select *Performance* > *S3 operations*.
...
| Select *SUPPORT* > *Tools* > *Grid topology*. On the Overview tab in the API Operations section, view the value for S3 Operations - Failed.
