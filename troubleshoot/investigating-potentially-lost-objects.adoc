...
---
= Resolve the objects potentially lost alert in StorageGRID
:icons: font
:imagesdir: ../media/
...
Technical support might ask you to determine if there is a storage recovery procedure in progress. Refer to:
