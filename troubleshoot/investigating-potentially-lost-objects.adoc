...
Technical support might ask you to determine if there is a storage recovery procedure in progress. Refer to link:../maintain/restoring-volume.html[Restore object data using Grid Manager].
|===
