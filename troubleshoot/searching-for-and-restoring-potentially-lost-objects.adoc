...
[.lead]
It might be possible to find and restore objects that have triggered a Lost Objects (LOST) alarm and an *Object lost* alert and that you have identified as potentially lost.
