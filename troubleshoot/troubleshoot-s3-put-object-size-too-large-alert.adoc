...
---
= Resolve the S3 PUT object size too large alert in StorageGRID
:icons: font
:imagesdir: ../media/
...
.. Go to *Support* > *Tools* > *Log collection*. Collect application logs for the Storage Node in the alert. Specify 15 minutes before and after the alert. Refer to link:../monitor/collecting-log-files-and-system-data.html[Collect log files and system data].
