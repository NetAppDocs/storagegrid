...
---
= Troubleshoot Admin Node and user interface issues in StorageGRID
:icons: font
:imagesdir: ../media/
...
. If single sign-on (SSO) is enabled for your StorageGRID system, refer to set up SSO using link:../admin/learn-about-setting-up-sso-oidc.html[OIDC] or link:../admin/learn-about-setting-up-sso-saml.html[SAML].
+
