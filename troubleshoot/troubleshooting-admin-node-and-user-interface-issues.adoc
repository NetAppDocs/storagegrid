...
. If single sign-on (SSO) is enabled for your StorageGRID system, refer to the steps for link:../admin/configure-sso-saml-saml.html[configuring single sign-on].
+
