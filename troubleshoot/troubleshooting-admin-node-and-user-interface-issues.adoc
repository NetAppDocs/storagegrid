...
. If single sign-on (SSO) is enabled for your StorageGRID system, refer to configure SSO using link:../admin/configure-sso-saml.html[SAML] or link:../admin/learn-about-setting-up-sso-oidc.html[OIDC].
+
