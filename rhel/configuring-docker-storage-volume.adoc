...
NOTE: Support for Docker as the container engine for software-only deployments is deprecated. Docker will be replaced with another container engine in a future release. Refer to this link:../rhel/software-requirements.html#docker-versions-tested[example of current support].
