...
NOTE: Support for using Docker as the container run-time for software-only deployments will be removed in a future StorageGRID release. Prepare for this change by using Podman for new StorageGRID 11.9 installations.
