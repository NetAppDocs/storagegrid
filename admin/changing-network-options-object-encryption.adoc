...
---
= Configure StorageGRID network and object security
:icons: font
:imagesdir: ../media/
...
+
NOTE: Beginning with StorageGRID 12.1.0, support for AES-128 encryption of new stored object data at rest is deprecated. Support continues for retrieval of stored objects that were originally encrypted with AES-128.
...
// 2026 AUG 2026, storagegrid-issue-78