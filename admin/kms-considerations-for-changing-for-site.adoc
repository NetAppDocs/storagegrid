...
---
= Considerations for changing the KMS for a StorageGRID site
:icons: font
:imagesdir: ../media/
...
+
image:kms_default_key.png[KMS Default Key]
...
+
image:kms_wrong_key.png[KMS Wrong Key]
...
+
image:kms_copied_key.png[KMS Copied Key]
