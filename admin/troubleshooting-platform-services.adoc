...
---
= Troubleshoot StorageGRID platform services
:icons: font
:imagesdir: ../media/
...
+
image:nodes_page_site_level_platform_services.gif[Nodes Page Site-Level Platform Services]
