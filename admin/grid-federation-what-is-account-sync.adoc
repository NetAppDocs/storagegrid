...
---
= Learn about account sync in StorageGRID
:icons: font
:imagesdir: ../media/
...
For details about the permitted tenant account workflow and to learn how groups, users, and S3 access keys are synced, refer to link:../tenant/grid-federation-account-sync.html[Sync tenant groups and users].
