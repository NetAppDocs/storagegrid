...
summary: 'Use Okta to create an application group for all Admin Nodes for OpenID Connect (OIDC) in your StorageGRID system.'
---
= Create application group in Okta for OIDC in StorageGRID 
:icons: font
:imagesdir: ../media/
...
== Step 1: Create an Okta application group
Create an Okta application group using the Okta UI.
...
. Select *Next*.
. Enter a name for the application group in the App Integration field.
...
After creating an application group, link:configure-sso-oidc.html[configure SSO using OIDC].
