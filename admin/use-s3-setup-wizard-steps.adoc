...
. If the *FabricPool and S3 setup wizard* banner appears on the dashboard, select the link in the banner. If the banner no longer appears, select the help icon image:icon-help-menu-bar.png[Help icon] from the header bar in the Grid Manager and select *FabricPool and S3 setup wizard*.
