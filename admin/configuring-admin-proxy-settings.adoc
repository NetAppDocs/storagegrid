...
For more information about AutoSupport, see link:../monitor/configure-autosupport-grid-manager.html[Configure AutoSupport].
...
+
* If you don't want to validate certificates when communicating with the admin proxy server, select *Do not verify proxy certificate*. This option isn't secure and isn't recommended.
