...
---
= StorageGRID S3 setup wizard considerations and requirements
:icons: font
:imagesdir: ../media/
...
Configure any grid federation connections:: If you want to allow the S3 tenant to sync account data and replicate bucket objects to another grid using a grid federation connection, confirm the following before starting the wizard:
+
