...
summary: 'Use Entra ID to create an application for each Admin Node in your system.'
---
...
. Select *Register*.
. On the Overview page for the new application registration, record the *Application (client) ID* and *Directory (tenant) ID*.
...
. On the Overview page for the new application registration, select *Manage* > *Certificates and secrets* > *New client secret*.
...
. On the Overview page for the new application registration, select *Manage* > *API permissions* > *Add a permission*.
...
. On the Overview page for the new application registration, select *Manage* > *Authentication*.
