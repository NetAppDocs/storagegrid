...
---
= Requirements and considerations for StorageGRID SSO
:icons: font
:imagesdir: ../media/
...
StorageGRID supports several SSO identity providers (IdP).

[role="tabbed-block"]
====
.OIDC
--
The following SSO IdPs are supported for OpenID Connect (OIDC):
...
.SAML
--
The following SSO IdPs are supported for Security Assertion Markup Language 2.0 (SAML 2.0):
