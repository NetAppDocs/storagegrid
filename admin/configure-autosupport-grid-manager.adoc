...
* *User-triggered*: Manually send AutoSupport packages at any time. This method is recommended over Weekly AutoSupport. Refer to link:../admin/manually-triggering-autosupport-message.html[Manually trigger an AutoSupport package] and link:../monitor/collecting-log-files-and-system-data.html[Collect log files and system data].
