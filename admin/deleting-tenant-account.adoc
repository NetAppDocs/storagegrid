...
---
= Delete a StorageGRID tenant account
:icons: font
:imagesdir: ../media/
...
* If the tenant is permitted to use grid federation connections, you have reviewed the considerations for link:../admin/grid-federation-manage-tenants.html[deleting a tenant with the Use grid federation connection permission]. Deletions are synced, so if a tenant is deleted on any grid, it will be deleted on all selected grids.
