...
* If the tenant is permitted to use grid federation connections, you have reviewed the considerations for link:grid-federation-manage-tenants.html[deleting a tenant with the Use grid federation connection permission].
