...
+
NOTE: SSH requires access on port 22 between the primary Admin Node and all other grid nodes. Remove access on port 22 when you complete the maintenance task.
