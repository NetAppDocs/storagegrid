...
---
= Use the StorageGRID Grid Management API
:icons: font
:imagesdir: ../media/
...
.Steps
. From the Grid Manager header, select the help icon image:icon_help_menu_bar.png[Help icon] and select *API documentation*.
...
+
image:swagger_example.png[Example from Swagger UI]
