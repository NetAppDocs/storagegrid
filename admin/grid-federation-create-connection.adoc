...
summary: 'You can create grid federation connections between two StorageGRID systems if you want to clone tenant details and replicate object data.'
---
...
[.lead]
You can create grid federation connections between two StorageGRID systems if you want to clone tenant details and replicate object data.
