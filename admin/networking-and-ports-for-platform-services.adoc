...
---
= Network and ports for StorageGRID platform services
:icons: font
:imagesdir: ../media/
...
+
This endpoint can be hosted on various web servers, frameworks, or data processing tools such as Fluentd.
