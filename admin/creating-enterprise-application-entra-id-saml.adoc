...
[.lead]
You use Entra ID to create an enterprise application for each Admin Node for SAML in your system.
...
. link:../admin/configure-sso-saml.html#test-sso[Test each application].
