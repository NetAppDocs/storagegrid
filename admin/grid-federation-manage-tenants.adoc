...
+
NOTE: S3 access keys for federated users are synced one time when they're created. If these S3 access keys are edited or deleted, these changes aren't synced to other grids. You must manually edit or delete the S3 access keys on the other grids.
