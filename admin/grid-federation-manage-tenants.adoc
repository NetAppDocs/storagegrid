...
image:grid_federation_remove_permission.png[steps to remove grid federation connection]
...
+
image:grid_federation_remove_permission_error.png[error message shown if tenant has cgr enabled for a bucket]
+
