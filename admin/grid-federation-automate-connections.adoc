...
* You've disabled single sign-on (SSO) on every grid.
...
TIP: You can also manage grid federation connections using the Grid Manager or the Grid Management API directly.
...
| Disables SSL certificate verification for local-to-grid conn
|===
