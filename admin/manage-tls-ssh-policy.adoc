...
.. When prompted, link:../maintain/rolling-reboot-procedure.html[reboot in a rolling fashion] to activate the NetApp Cryptographic Security Module. Use *Maintenance* > *Rolling reboot* to initiate and monitor reboots.
