...
In the screenshot, the *Actual reserved* value is 8 TB. This screenshot is for a large Storage Node in a new StorageGRID 12.1 installation. Because the system-wide Metadata reserved space setting is greater than volume 0 for this Storage Node, the entire volume is reserved.
