...
If an S3 client issues a PutObjectRetention or PutObjectLegalHold request, the request sent to the source object is accepted but isn't replicated to the destination object.
