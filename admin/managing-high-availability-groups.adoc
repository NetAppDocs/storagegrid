...
You can use high availability (HA) groups to provide highly available data connections for S3 clients or to provide highly available connections to the Grid Manager and the Tenant Manager.
