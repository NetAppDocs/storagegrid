...
. Select the <<create-client-oidc,OIDC client>> you created.
. Select *Add*.
...
.Steps
. Check that you've saved the <<create-client-oidc,client ID>> and the <<client-secret-oidc,client secret>> from the OIDC client that you created.
