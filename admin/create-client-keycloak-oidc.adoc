...
You can create a Keycloak realm to configure the LDAP provider and OIDC client, or use the Keycloak default realm.
...
+
You need to resolve any issues that might occur before continuing.
. Select *Save*.
