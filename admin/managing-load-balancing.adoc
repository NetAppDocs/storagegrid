...
Caching significantly improves performance when a workload operates on a subset of data and accesses objects multiple times. Load balancer caching is available only for Gateway Nodes.
