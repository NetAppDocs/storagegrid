...
summary: "You can help protect against Cross-Site Request Forgery (CSRF) attacks against StorageGRID by using CSRF tokens to enhance authentication that uses cookies."
---
= Protect against Cross-Site Request Forgery (CSRF) in StorageGRID
:icons: font
:imagesdir: ../media/
