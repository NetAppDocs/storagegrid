...
---
= Troubleshoot grid federation errors in StorageGRID
:icons: font
:imagesdir: ../media/
...
.Details
The password you set for the tenant's local root user and other local users are automatically synced. However, you might need to change the password for the tenant's local root user on the destination grid before you can sign in to the tenant account on that grid.
...
image:grid_federation_last_error.png[Screenshot showing a message in the Last error column of a grid federation connection]
