...
* The source object has S3 Object Lock headers that don't comply with the destination grid's tenant-level retention settings and restrictions.
* The source object has S3 Object Lock headers and S3 Object Lock is disabled on the destination bucket. 
