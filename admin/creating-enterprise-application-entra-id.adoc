...
* You have link:../admin/configure-sso-saml-saml-saml.html#enter-sandbox-mode[entered sandbox mode] in Grid Manager.
...
. link:../admin/configure-sso-saml-saml.html#test-sso[Test each application].
