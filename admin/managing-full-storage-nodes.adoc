...
summary: "As Storage Nodes reach capacity, you must expand the StorageGRID system through the addition of new storage. You can do this by adding storage volumes, adding storage expansion shelves, and adding Storage Nodes."
---
= Manage full Storage Nodes in StorageGRID
:icons: font
:imagesdir: ../media/
