...
* You have the fully qualified domain name (or the IP address) and the relying party identifier for each Admin Node in your system. You can copy these values from the Admin Node details table on the link:configure-sso-oidc.html[Configure SSO page].
+
