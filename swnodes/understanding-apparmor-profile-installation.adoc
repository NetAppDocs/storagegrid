...
---
= Learn about AppArmor profiles for StorageGRID on Ubuntu and Debian
:icons: font
:imagesdir: ../media/
...
* Disable AppArmor altogether. For Ubuntu 9.10 or later, follow the instructions in the https://help.ubuntu.com/community[Ubuntu online community]. Disabling AppArmor altogether might not be possible on newer Ubuntu versions. 
+
