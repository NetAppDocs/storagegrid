...
summary: 'You can use the VMware OVF Tool to automate the deployment of StorageGRID nodes. You can also automate the configuration of StorageGRID.'
---
= Automate the deployment of StorageGRID nodes with VMware vSphere
:icons: font
:imagesdir: ../media/
