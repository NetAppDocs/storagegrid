...
summary: 'You can use the VMware OVF Tool to automate the deployment of grid nodes in StorageGRID. You can also automate the configuration of StorageGRID.'
---
= Automate the deployment of grid nodes in StorageGRID with VMware vSphere
:icons: font
:imagesdir: ../media/
