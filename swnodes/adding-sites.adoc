...
. To add additional sites, select the plus sign next to the last site entry and enter the name in the new *Site name* text box.
+
Add as many additional sites as required for your grid topology. You can add up to 16 sites.
+
image:3_gmi_installer_sites_page.gif[This image is explained by the surrounding text.]
