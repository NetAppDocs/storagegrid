...
summary: "You can automate the installation of the StorageGRID host service and the configuration of grid nodes on Linux."
---
= Automate installation of StorageGRID host service and the configuration of grid nodes on Linux
:icons: font
:imagesdir: ../media/
