...
---
= StorageGRID node container migration requirements for Linux
:icons: font
:imagesdir: ../media/
...
image:eth0_bond.gif[This image is explained by the surrounding text.]
...
image:block_device_mapping_rhel.gif[Block device mapping]
