...
** If multiple tenants each have approximately 5,000 buckets, at least 64 GB per node
+
NOTE: The StorageGRID system supports a maximum of 5,000 buckets for each S3 tenant account.
