...
---
= CPU and RAM requirements for StorageGRID
:icons: font
:imagesdir: ../media/
...
** If multiple tenants each have up to 5,000 buckets, at least 64 GB per node
+
NOTE: The StorageGRID system supports a maximum of 20,000 buckets for each S3 tenant account.
...
Refer to also link:storage-and-performance-requirements.html[Storage and performance requirements].
