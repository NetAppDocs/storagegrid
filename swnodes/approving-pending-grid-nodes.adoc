...
---
= Approve pending grid nodes for StorageGRID
:icons: font
:imagesdir: ../media/
...
+
image:5_gmi_installer_grid_nodes_pending.gif[This image is explained by the surrounding text.]
...
Rebooting can take several minutes.
 ...
 .. Return to the Home page and select *Start installation*.
...
+
image:7_gmi_installer_grid_nodes_approved.gif[This image is explained by the surrounding text.]

. Repeat these steps for each pending grid node you want to approve.
+
You must approve all nodes that you want in the grid. However, you can return to this page at any time before you select *Install* on the Summary page. You can modify the properties of an approved grid node by selecting its radio button and selecting *Edit*.

. When you are done approving grid nodes, select *Next*.
