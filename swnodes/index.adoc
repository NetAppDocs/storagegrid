...
summary: 'Follow these high-level steps to install a RHEL, Ubuntu, Debian, or VMware StorageGRID node.'
---
...
[.lead]
Follow these high-level steps to install a Red Hat Enterprise Linux (RHEL), Ubuntu, Debian, or VMware StorageGRID node.
