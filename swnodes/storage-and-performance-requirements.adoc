...
== Example: Calculating the storage requirements for a Linux host
...
== Example: Calculating the storage requirements for VMare virtual machines
...
Linux and VMware have the same storage requirements for storage nodes.
