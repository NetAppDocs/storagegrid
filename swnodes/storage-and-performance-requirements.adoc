...
a|12 TB (4 TB/LUN) See <<storage_req_SN_r,Storage requirements for Storage Nodes>> for more information.

a|Storage Node (metadata-only)
a|Object metadata
a|1
a|4 TB See <<storage_req_SN_r,Storage requirements for Storage Nodes>> for more information. 
...
| 12 TB (4 TB/LUN) See <<storage_req_SN_u,Storage requirements for Storage Nodes>> for more information.

| Storage Node (metadata-only)
| Object metadata
| 1
| 4 TB See <<storage_req_SN_u,Storage requirements for Storage Nodes>> for more information. 
