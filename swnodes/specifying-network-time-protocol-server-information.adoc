...
---
= Specify Network Time Protocol server information for StorageGRID
:icons: font
:imagesdir: ../media/
...
https://learn.microsoft.com/en-us/troubleshoot/windows-server/active-directory/support-boundary-high-accuracy-time[Support boundary for high-accuracy time^]
====
...
+
image:8_gmi_installer_ntp_page.gif[This image is explained by the surrounding text.]
