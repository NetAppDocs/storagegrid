...
---
= Learn about the StorageGRID installation REST API
:icons: font
:imagesdir: ../media/
...
* *recovery*: Primary Admin Node recovery operations. You can reset information, upload the Recovery Package, start the recovery, and view the status of the recovery operation.
