...
. Refer to link:../network/internal-grid-node-communications.html[Internal grid node communications] and link:../network/external-communications.html[External communications] to ensure that all required ports for StorageGRID 12.1 are opened before you upgrade.
+
NOTE: No additional ports are required when upgrading to StorageGRID 12.1.