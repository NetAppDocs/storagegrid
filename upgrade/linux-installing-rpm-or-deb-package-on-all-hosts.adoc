...
[root@rhel-example ~]#
----
.. Remove previous StorageGRID packages: `dnf remove <images-package> <service-package>`
+
...
Removed:
  StorageGRID-Webscale-Images-11-6-0-11.6.0-20220210.0232.8d56cfe.x86_64                StorageGRID-Webscale-Service-11-6-0-11.6.0-20220210.0232.8d56cfe.x86_64               
...
.. Remove previous StorageGRID packages: `dpkg -r <images-package> <service-package>`
+
Example:
+
----
...
.. Remove the container images for previous StorageGRID versions: `docker rmi <image id>`
+
Example:
+
----
...
.. Remove the container images for previous StorageGRID versions: `podman rmi <image id>`
+
Example:
+
----
