...
NOTE: Upgrade the Storage Nodes one site at a time. When you approve multiple sites at the same time, Storage Nodes will be automatically grouped by site.
