...
+
NOTE: For a StorageGRID 12.0 upgrade, if you want to approve individual nodes instead of all nodes, best practice is to upgrade an entire site before moving on to the next site.
+
