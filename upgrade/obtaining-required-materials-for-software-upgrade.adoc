...
Ensure your Linux operating system meets StorageGRID's minimum kernel version requirements. See link:../install-nodes/installing-linux.html[Install StorageGRID on Linux hosts].
