...
NOTE: This list applies specifically to upgrades from StorageGRID 11.9 to StorageGRID 12.0 or later. If you're upgrading to another StorageGRID release, refer to the list of restricted changes in the upgrade instructions for that release.
...
* Don't delete any HA groups until the upgrade to StorageGRID 12.0 or later is complete. Virtual IP addresses in other HA groups might become inaccessible.
