...
*	SG6060 and SGF6024 appliances are automatically upgraded to BIOS firmware version 3B08.EX.
*	SG100 and SG1000 appliances are automatically upgraded to BIOS firmware version 3B13.EC.
