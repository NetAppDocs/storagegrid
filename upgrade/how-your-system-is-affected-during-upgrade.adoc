...
NOTE: This list applies specifically to upgrades from StorageGRID 12.0 to StorageGRID 12.1 or later. If you're upgrading to another StorageGRID release, refer to the list of restricted changes in the upgrade instructions for that release.
