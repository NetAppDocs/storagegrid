...
| The upgrade to StorageGRID 12.0 requires a Cassandra database upgrade. After you upgrade from StorageGRID 11.9 to 12.0, a metadata format update will occur in the background for one to three days. You won't be able to run any other streaming maintenance procedures during this time.
