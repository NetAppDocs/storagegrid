...
Per-tenant configuration capabilities provide the appropriate balance of flexibility and data security. You can now:

* Configure per-tenant retention settings
* Allow or disallow compliance mode at the tenant level
