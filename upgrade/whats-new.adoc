...
== Tenant groups enhancements

=== AssumeRole
You now have greater control over managing temporary credentials in tenant groups with AssumeRole. AssumeRole allows a user, who is not a member of a particular group, to temporarily assume the role of a user in that group.
