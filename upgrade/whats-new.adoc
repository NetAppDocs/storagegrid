...
== S3
=== Branch buckets
You can now link:../tenant/what-is-branch-bucket.html[create branch buckets] for an S3 bucket. A branch bucket provides access to S3 bucket objects as they existed at a certain time.
