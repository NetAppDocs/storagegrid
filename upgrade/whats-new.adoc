...
=== AssumeRole
StorageGrid now supports link:../tenant/manage-groups/set-up-assumerole.html[AssumeRole]. You can now configure a new S3 trust policy to support the AssumeRole API.
