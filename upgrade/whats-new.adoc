...
Fresh installations of StorageGRID 11.9 default to local node audit destinations. Before StorageGRID 11.8, audit messages were sent to the audit log (`/var/local/log/audit.log`) on Admin Nodes only.
