...
=== AssumeRole
StorageGRID now supports link:../tenant/manage-groups.html#set-up-assumerole[Set up AssumeRole]. You can now configure a new S3 trust policy to support the AssumeRole API.
