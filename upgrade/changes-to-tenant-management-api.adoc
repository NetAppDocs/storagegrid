...
You can use the `/org/containers/{bucketName}/quota-object-bytes` API endpoint with GET/PUT operations to get and set the storage capacity limit for a bucket.
