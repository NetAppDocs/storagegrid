...
You can use the `/org/containers/{bucketName}/quota-object-bytes` API endpoint with GET/PUT operations to set and get the storage capacity limit for a bucket.
