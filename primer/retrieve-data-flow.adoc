...
---
= How StorageGRID handles object retrieval
:icons: font
:imagesdir: ../media/
...
image:retrieve_data_flow.png[Retrieve]
...
. The source LDR service returns the retrieved object data to the queried LDR service, and the system returns the object to the client application.
