...
image:object_conceptual_drawing.png[Object]
...
image:ilm_replication_make_2_copies.png[Make 2 Copies rule]
...
image:ec_three_sites_4_plus_2.png[Erasure Coded Three Sites 4 Plus 2]
