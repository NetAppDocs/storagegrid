...
---
= How StorageGRID handles object deletion
:icons: font
:imagesdir: ../media/
...
See link:../ilm/how-objects-and-delete-markers-are-deleted.html[How objects and delete markers are deleted] for more information.

== Data flow for client deletes

image:delete_data_flow.png[Client delete data flow]
...
image:automatic_deletion_data_flow.png[Automatic deletion data flow]
