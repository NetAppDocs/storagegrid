...
* When installing metadata-only nodes:
** Single-site grid: At least two combined or data-only Storage Nodes (can be any combination)
** Multi-site grid: At least one combined or data-only Storage Node _per site_ (can be any combination)
