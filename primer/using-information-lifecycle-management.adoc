...
---
= Information lifecycle management in StorageGRID
:icons: font
:imagesdir: ../media/
...
* Which objects should be stored. A rule can apply to all objects, or you can specify filters to identify which objects a rule applies to. For example, a rule can apply only to objects associated with certain tenant accounts, specific S3 buckets, or specific metadata values.
