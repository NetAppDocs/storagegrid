...
image:storagegrid_system_diagram.png[Image with multiple clients]
...
* The Amazon Web Services Simple Storage Service (S3) standard object storage protocol.
