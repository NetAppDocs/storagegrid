...
[.lead]
A StorageGRID system consists of multiple types of grid nodes at one or more data center sites and has certain requirements for the number of nodes and sites in a deployment:
