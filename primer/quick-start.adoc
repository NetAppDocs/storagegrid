...
[role="quick-margin-para"]
Review link:index.html[Learn about StorageGRID] and link:../network/index.html[Networking guidelines].
...
[role="quick-margin-para"]
When grid installation is complete, you can sign in to the Grid Manager. From there, you can review the general health of your new system, enable AutoSupport and alert emails, and set up S3 endpoint domain names.
