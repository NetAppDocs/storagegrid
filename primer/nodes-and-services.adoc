...
Software-based grid nodes can be deployed as VMware virtual machines or within container engines on a Linux host. See link:../install-nodes/index.html[Install StorageGRID on software-based nodes].
