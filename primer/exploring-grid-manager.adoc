...
---
= Explore the StorageGRID Grid Manager
:icons: font
:imagesdir: ../media/
...
image:grid_manager_dashboard_and_menu.png[Dashboard in the Grid Manager]

For an explanation of the information shown on each card, select the help icon image:icon_nms_question.png[question mark icon] for that card.
...
The help menu image:icon-help-menu-bar.png[help icon on the menu bar] provides access to:
...
* Configure email notifications for StorageGRID alerts
...
* Use link:../admin/grid-federation-overview.html[grid federation] to sync tenant account information and replicate object data between two StorageGRID systems
...
* link:../monitor/configure-email-server.html[Configure email server]
* link:../monitor/configure-log-management.html[Configure log management]
...
* link:../admin/about-multi-admin-verify.html[Configure multi-admin verification]
