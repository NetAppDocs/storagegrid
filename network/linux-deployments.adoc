...
---
= Network configuration for StorageGRID Linux deployments
:icons: font
:imagesdir: ../media/
...
See the link:../install-nodes/index.html[installation instructions].
...
For some recommended ways of configuring physical and network resources on the hosts in your StorageGRID cluster to prepare for your StorageGRID deployment, see link:../install-nodes/configuring-host-network.html[Configure the host network].
