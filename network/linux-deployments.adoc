...
See the link:../swnodes/index.html[installation instructions].
...
For some recommended ways of configuring physical and network resources on the hosts in your StorageGRID cluster to prepare for your StorageGRID deployment, see link:../swnodes/configuring-host-network.html[Configure the host network].
