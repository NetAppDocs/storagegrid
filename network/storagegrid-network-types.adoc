...
For details about mapping virtual or physical ports to node network interfaces, see link:../install-nodes/index.html[Install StorageGRID on software-based nodes].
