...
For information about setting audit message levels, changing log destinations, and using an external syslog server for your audit information, see link:../monitor/configure-log-management[Configure log management and external syslog server]