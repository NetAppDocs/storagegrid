...
summary: "Audit logs files are saved to an Admin Node’s varlocalauditexport directory. The active audit log files are named audit.log."
---
= Learn about audit log file rotation in StorageGRID
:icons: font
:imagesdir: ../media/
