...
summary: "The LKDM audit message is generated when a leaked chunk has been cleaned or deleted."
---
= LKDM audit message for leaked object cleanup in StorageGRID
:icons: font
:imagesdir: ../media/
