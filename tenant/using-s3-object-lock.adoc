...
---
= Use S3 Object Lock to retain objects in StorageGRID
:icons: font
:imagesdir: ../media/
...
Learn about link:../ilm/requirements-for-s3-object-lock.html#s3-object-lock-existing-buckets[S3 Object Lock requirements]