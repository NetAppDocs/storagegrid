...
---
= Change object versioning for an S3 bucket in StorageGRID
:icons: font
:imagesdir: ../media/
...
* link:../ilm/how-objects-and-delete-markers-are-deleted.html[How objects and and delete markers are deleted]
