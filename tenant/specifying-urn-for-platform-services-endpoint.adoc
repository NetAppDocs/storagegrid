...
---
= Specify a URN for a StorageGRID platform services endpoint
:icons: font
:imagesdir: ../media/
...
----
+
NOTE: Optionally, you can include `mysite` when specifying a Kafka endpoint: `urn:mysite:kafka:::kafka-topic-name`
+
