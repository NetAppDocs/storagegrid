...
+
If your tenant account has the *Use grid federation connection* permission, a blue banner indicates that this is the tenant's source grid. Any local users you create on this grid will be cloned to the other grids in the connection.
+
...
** A  banner message indicates that if you edit or remove a user, your changes will be synced to the other grids in the connection.
...
*** A blue banner indicating that if you edit this user, your changes will be synced to the other grids in the connection.
...
NOTE: If your tenant account has the *Use grid federation connection* permission and you delete a local user, StorageGRID will not delete the corresponding user on the other grids in the connection. If you need to keep this information in sync, you must delete the same user from both grids.
