...
Branch bucket depth limit:: A branch bucket can have a maximum of 20 base buckets.
+
...
**	Branch bucket *D*, created from *C*, has three base buckets: *C* (explicit), *B* and *A* (implied).
