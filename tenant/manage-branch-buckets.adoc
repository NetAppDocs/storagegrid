...
+
Capacity limit is the maximum capacity available for the branch bucket. This value represents a logical amount (object size), not a physical amount (size on disk). The maximum supported object size is 100 TiB.
+
...
+
Object count limit is the maximum number of objects the branch bucket can contain. This value represents a logical amount (object count). The maximum supported object count is 48.
+
