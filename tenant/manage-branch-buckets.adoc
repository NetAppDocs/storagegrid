...
Before:: The branch bucket provides access to object versions created earlier than _Before_ time. The Before time must be a date and time that has passed. It can't be a future date.
