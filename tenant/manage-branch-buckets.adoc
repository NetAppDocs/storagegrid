...
Branch bucket depth limit:: A branch bucket can have a maximum of 20 base buckets. A depth of more than 20 branch buckets can increase S3 access latency, especially for ListObjectVersions.
+
...
S3 Object Lock permissions:: Permissions to set S3 Object Lock properties of buckets or objects can be granted by link:../tenant/using-s3-object-lock.html[using specific features of S3 Object Lock].
