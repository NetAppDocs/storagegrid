...
---
= Delete a StorageGRID S3 bucket
:icons: font
:imagesdir: ../media/
...
You can't delete an S3 bucket if it contains objects, noncurrent object versions, or delete markers. For information about how S3 versioned objects are deleted, see link:../ilm/how-objects-and-delete-markers-are-deleted.html[How objects and delete markers are deleted].
