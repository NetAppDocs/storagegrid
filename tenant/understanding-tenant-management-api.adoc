...
---
= Learn about the StorageGRID Tenant Management API
:icons: font
:imagesdir: ../media/
...
* *s3-configurations*: Operations to retrieve S3 global configurations.
...
image:tenant_api_swagger_example.gif[example showing GET groups operation in Swagger API]
