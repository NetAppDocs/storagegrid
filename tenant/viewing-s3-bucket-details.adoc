...
** link:../s3/bucket-and-group-access-policies.html[Control user access for an S3 bucket and objects] in that bucket. You must have the Root access permission to change this setting.
