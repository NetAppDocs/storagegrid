...
* *Branches*: View the list of branch buckets for the bucket. link:../tenant/manage-branch-buckets.html[Create a new branch bucket] or link:../tenant/manage-branch-buckets.html[manage branch buckets].