...
+
NOTE: Each grid can have a maximum of 100,000 buckets, including link:../tenant/manage-branch-buckets.html[branch buckets].
...
* You want to create a link:../tenant/manage-branch-buckets.html[branch bucket] from this bucket.
