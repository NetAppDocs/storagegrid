...
+
NOTE: The StorageGRID system supports a maximum of 5,000 buckets for each S3 tenant account. Each grid can have a maximum of 100,000 buckets, including link:../tenant/what-is-branch-bucket.html[branch buckets]. There's also a limit to link:../tenant/manage-branch-buckets.html[branch bucket depth].
