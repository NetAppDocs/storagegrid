...
The workflow diagram summarizes the steps you perform to configure cross-grid replication between buckets on two grids. These steps are described in more detail below.
