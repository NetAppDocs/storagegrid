...
* When clients access objects in a branch bucket, the branch bucket's link:../s3/bucket-and-group-access-policies.html[access policies], rather than the policies of the base bucket, determine whether access is granted or denied.
