...
* If you enable S3 Object Lock on the destination bucket after you configure CloudMirror replication, you might have to link:../tenant/editing-platform-services-endpoint.html[re-save the endpoint] to allow replication to resume.
