...
summary: 'You can use CloudMirror replication to automatically replicate objects to an external S3 bucket.'
---
...
[.lead]
You can use CloudMirror replication to automatically replicate objects to an external S3 bucket.
