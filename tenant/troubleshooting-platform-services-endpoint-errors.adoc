...
---
= Troubleshoot StorageGRID platform services endpoint errors
:icons: font
:imagesdir: ../media/
...
image:tenant_dashboard_endpoint_error.png[endpoint error message on the dashboard]
...
. On the endpoint details page, select *Connection*. This tab displays only the most recent error for an endpoint and indicates how long ago the error occurred. Errors that include the red X icon image:icon_alert_red_critical.png[Red X Icon] occurred within the past 7 days.
