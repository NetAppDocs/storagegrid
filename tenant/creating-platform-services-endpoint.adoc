...
---
= Create a StorageGRID platform services endpoint
:icons: font
:imagesdir: ../media/
...
|===
--
.Webhook and Kafka endpoints
--
Verify the TLS connection for webhook or Kafka endpoints.
...
*Note*: Webhook endpoints don't have this option.
|===
...
NOTE: If you enable S3 Object Lock on the destination bucket after you configure CloudMirror replication, you might have to re-save the endpoint to allow replication to resume.
