...
| Disabled
| Certificate verification is disabled. This option isn't secure and isn't recommended.
...
| Disables the server certificate verification, which means the server's identity isn't verified. This option isn't secure and isn't recommended.
