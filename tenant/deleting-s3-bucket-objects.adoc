...
+
image:delete-bucket-objects-in-progress.png[screenshot showing bucket objects being deleted]
...
+
image:delete-bucket-objects-complete.png[screenshot showing all bucket objects deleted]
