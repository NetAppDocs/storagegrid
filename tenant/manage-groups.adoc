...
To set up AssumeRole, create the target group to be assumed, if the group does not already exist. Edit the group's S3 policy to specify the permitted actions by assuming this group. 
