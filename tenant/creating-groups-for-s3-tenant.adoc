...
---
= Create groups for an S3 tenant in StorageGRID
:icons: font
:imagesdir: ../media/
...
+
If your tenant account has the *Use grid federation connection* permission and you are on the tenant's source grid, the new group is synced to the tenant's destination grid. *Succeeded* appears as the Sync status in the Overview section of the group's detail page.