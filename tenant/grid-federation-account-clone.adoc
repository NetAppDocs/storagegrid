...
---
= Clone tenant groups and users in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:grid-federation-account-clone-workflow-tm.png[the tenant's workflow for account clone. Steps are described in the following text.]
...
image:grid-federation-account-clone.png[image showing that local groups are cloned from source grid to destination grid]
...
image:grid-federation-local-user-clone.png[image showing that local users are cloned from source grid to destination grid]
...
image:grid-federation-federated-group-clone.png[image showing that federated groups are cloned from source grid to destination grid]
...
image:grid-federation-s3-access-key.png[image showing that s3 access keys can be optionally cloned from source grid to destination grid]
...
image:grid-federation-account-not-cloned.png[image showing that details on destination grid aren't cloned to source grid]
...
image:grid-federation-account-clone-edit-delete.png[image showing that edited or deleted details aren't cloned]
