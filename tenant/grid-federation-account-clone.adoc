...
[role="quick-margin-para"]
If you need to access buckets with the same access keys on all grids, create the access keys on one of the grids. The access keys are automatically synced by default.
