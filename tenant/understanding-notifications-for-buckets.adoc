...
---
= Learn about StorageGRID event notifications for S3 buckets
:icons: font
:imagesdir: ../media/
...
* After you create or edit a webhook endpoint, StorageGRID sends the following test message to verify the endpoint is reachable: `{"testMessage":"StorageGRID Test Message”}`. You can ignore these test messages.

// 2026 AUG 6, SGRIDDOC-271
