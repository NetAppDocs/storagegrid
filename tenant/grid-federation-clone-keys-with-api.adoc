...
+
image:grid_federation_post_current_user_replicate.png[POST endpoint for replicating own access key]
...
+
image:grid_federation_clone_access_key.png[Tenant Manager API entering values to clone access key]
...
+
image:grid_federation_post_other_user.png[POST endpoint for replicating another user's access key]
