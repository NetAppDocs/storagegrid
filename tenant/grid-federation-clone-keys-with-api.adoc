...
summary: If your StorageGRID tenant account has the Use grid federation connection permission, you can use the Tenant Management API to manually clone S3 access keys between StorageGRID grids.
---
