...
---
= Storage pool configuration guidelines in StorageGRID
:icons: font
:imagesdir: ../media/
...
Refer to link:using-multiple-storage-pools-for-cross-site-replication.html[Examples of enabling site-loss protection using replication and erasure coding].
