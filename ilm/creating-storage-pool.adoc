...
---
= Create a storage pool in StorageGRID
:icons: font
:imagesdir: ../media/
...
NOTE: When you install StorageGRID 12.0 or later on a new grid, storage pools are automatically created for each site. However, if you initially installed StorageGRID 11.6 or earlier, storage pools aren't automatically created for each site.
...
+
To remove an entry, select the delete icon image:icon_x_to_remove.png[delete icon].
