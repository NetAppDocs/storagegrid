...
* "Cloud Storage Pool Test Failed" for AMRA or anonymous access authentication type
...
Try correct this issue, follow the steps in link:editing-cloud-storage-pool.html[Edit a Cloud Storage Pool] without making any changes. This triggers the validation to update the S3 Object Lock flag.
