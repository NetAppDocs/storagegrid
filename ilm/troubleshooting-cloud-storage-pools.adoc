...
You might encounter this error when you enable the default retention mode after enabling S3 Object Lock. This error occurs if the PUT operation does not have a request header value, such as `Content-MD5`.
