...
After enabling the S3 Object Lock, a grid administrator can also allow tenant users to enable S3 Object Lock on an existing bucket. After enabling this setting, it can be disabled. For more information, refer to link:requirements-for-s3-object-lock.html#s3-object-lock-existing-buckets[S3 Object Lock requirements].
