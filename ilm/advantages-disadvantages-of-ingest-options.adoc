...
---
= Advantages, disadvantages, and limitations of ILM ingest options in StorageGRID
:icons: font
:imagesdir: ../media/
...
NOTE: Before selecting a consistency value, link:../s3/consistency.html[read the full description of consistency]. You should understand the benefits and limitations before changing the default value.
