...
---
= ILM rules and policy for EC object size filtering in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:policy_2_rule_1_ec_objects_adv_filtering.png[ILM rule 1 for example 2: Use EC for all objects greater than 1 MB]
