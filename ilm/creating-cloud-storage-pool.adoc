...
* The external bucket or container referenced by the Cloud Storage Pool already exists, and you know its <<bucket-name,name and location>>.
...
. [[bucket-name]]Select *Create*, then enter the following information:
+
