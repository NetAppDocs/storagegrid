...
---
= Create a Cloud Storage Pool in StorageGRID
:icons: font
:imagesdir: ../media/
...
| Selecting this option means that TLS connections to the Cloud Storage Pool aren't secure. This option isn't recommended.
|===
+
. Select *Save*.
+
