...
summary: "When you create an ILM rule, you can protect objects at ingest by specifying either Dual commit, Strict, or Balanced."
---
= ILM ingest options in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:ingest_object_lifecycle.png[Diagram showing how object ingest occurs for each ingest option]
