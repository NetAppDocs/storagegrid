...
---
= ILM rules and policy for protecting image files in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:policy_3_rule_1_ec_images_adv_filtering.png[ILM rule 1 for example 3: Use EC for image files greater than 1 MB]
...
image:policy_3_configured_policy.png[ILM policy for example 3: Better protection for image files]