...
.. For each custom storage grade you want to add, select *Insert* image:../media/icon_nms_insert.gif["insert icon"]o add a row.
...
.. Optionally, if you need to  modify a saved label, select *Edit* image:../media/icon_nms_edit.gif["edit icon"]nd select *Apply Changes*.
+
