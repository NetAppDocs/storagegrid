...
---
= ILM rules and policies for noncurrent S3 object versions in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:ilm_rule_apply_only_to_older_object_verions.png[Apply ILM rule only to older object versions (Noncurrent time)]
...
link:how-objects-and-delete-markers-are-deleted.html[How objects and delete markers are deleted]