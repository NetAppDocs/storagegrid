...
---
= Learn about erasure coding in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:ec_three_sites_4_plus_2.png[Erasure Coding Three Sites 4 Plus 2]
...
image:ec_recoverable_4_plus_2.png[Erasure Coding Recoverable 4 Plus 2]

If more than two Storage Nodes are lost, the object is not retrievable.

image:ec_unrecoverable_4_plus_2.png[Erasure Coding Unrecoverable 4 Plus 2]
