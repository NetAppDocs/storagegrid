...
---
= Learn about ILM policies in StorageGRID
:icons: font
:imagesdir: ../media/
...
If the default policy doesn't meet your storage requirements, you can create your own rules and policies. See link:what-ilm-rule-is.html[Create an ILM rule] and link:creating-ilm-policy.html[Create an ILM policy].
...
image:ilm-policies-single.png[Single ILM policies diagram]
...
NOTE: You can link:../ilm/creating-ilm-policy.html#activate-ilm-policy[create a maximum of 10 policy tags] for your grid.
...
image:ilm-policies-tags-conceptual.png[Multiple ILM policies diagram]
...
image:ilm_policy_and_rules.png[ILM Policy and Rules]
