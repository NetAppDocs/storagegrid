...
---
= Define placement instructions for a StorageGRID ILM rule
:icons: font
:imagesdir: ../media/
...
image:ilm_create_ilm_rule_wizard_2.png[Create ILM Rule Wizard Step 2]
...
+
image:ilm_rule_retention_diagram.png[ILM Rule Retention Diagram]
