...
*Note:* To use this option, updates to Last access time must be enabled for the S3 bucket container. See link:using-last-access-time-in-ilm-rules.html[Use Last access time in ILM rules].
