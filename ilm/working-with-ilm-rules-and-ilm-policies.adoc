...
---
= Work with ILM policies and ILM rules in StorageGRID
:icons: font
:imagesdir: ../media/
...
+
image:ilm_rule_details_page.png[ILM rule details page]
...
+
You can select the question mark image:icon_nms_question.png[question mark icon] to see a description of the items on the ILM tab.
+
image:ilm_metrics_on_dashboard.png[ILM metrics on Grid Manager dashboard]