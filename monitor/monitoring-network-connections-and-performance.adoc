...
---
= Monitor networking and system resources in StorageGRID
:icons: font
:imagesdir: ../media/
...
+
image:nodes_menu.png[Nodes menu]
+
...
+
image:traffic_classification_policies_main_screen_w_examples.png[Traffic Policy for Graph Example]

 .. To view graphs that show the networking metrics associated with a policy, select the radio button to the left of the policy, and then select *Metrics*.
