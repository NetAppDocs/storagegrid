...
---
= External syslog servers in StorageGRID
:icons: font
:imagesdir: ../media/
...
To learn how to configure an external syslog server, see link:../monitor/configure-log-management.html[Configure log management and external syslog server].
