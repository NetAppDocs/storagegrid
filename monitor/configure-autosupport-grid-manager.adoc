...
== [[configure-autosupport-packages-to-be-sent]]Configure AutoSupport packages to be sent
...
To verify or change the protocol used to send AutoSupport packages, see the instructions to <<configure-autosupport-packages-to-be-sent,configure AutoSupport packages to be sent>>.
