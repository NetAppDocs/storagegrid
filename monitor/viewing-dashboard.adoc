...
---
= View and manage the dashboard in StorageGRID
:icons: font
:imagesdir: ../media/
...
Some of the cards can be maximized for easier viewing. Select the maximize icon image:icon_dashboard_card_maximize.png[Maximize icon] in the upper right corner of the card. To close a maximized card, select the minimize icon image:icon_dashboard_card_minimize.png[Minimize icon] or select *Close*.
...
image:dashboard_manage.png[Manage dashboards]
...
image:dashboard_configure.png[Configure dashboard]