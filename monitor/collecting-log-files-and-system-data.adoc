...
If a primary Admin Node reboot occurs during log collection, StorageGRID doesn't retain the results. You need to restart log collection after the reboot is complete.
