...
---
= Collect StorageGRID log files and system data
:icons: font
:imagesdir: ../media/
...
If the Admin Node used to start log collection goes offline during log collection, StorageGRID doesn't retain the results. You need to reboot the node and restart log collection after the reboot completes.
...
--
+
NOTE: You can choose to leave the Provisioning passphrase field empty for a standard retry, or you can enter the passphrase to retry using SSH. 
