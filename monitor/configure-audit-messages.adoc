...
* When you install StorageGRID 11.8 or later as a new installation, the audit information generated on Admin Nodes is stored in `/var/local/log/localaudit.log`. If you upgrade from  StorageGRID 11.7, the audit information is stored in `/var/local/audit/export/localaudit.log`.
====
