...
---
= Commonly used Prometheus metrics in StorageGRID
:icons: font
:imagesdir: ../media/
...
For details on the syntax of Prometheus queries, see https://prometheus.io/docs/prometheus/latest/querying/basics/[Querying basics^].
...
+
image:nodes_page_network_traffic_graph.png[Prometheus graph]
