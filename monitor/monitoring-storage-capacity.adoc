...
---
= Monitor storage capacity in StorageGRID
:icons: font
:imagesdir: ../media/
...
+
image:dashboard_data_and_metadata_space_usage_breakdown.png[Data and metadata space usage breakdown]
...
+
image:dashboard_storage_over_time.png[Storage over time chart]
...
+
image:nodes_deployment_storage_tab.png[Nodes Deployment Storage tab]
...
image:calculating_watermarks.gif[Conceptual drawing for Total usable space]
...
+
image:nodes_page_storage_used_object_data.png[Nodes Page Storage Used Object Data]

. Review the Available values in the Volumes and Object stores tables, below the graphs.
+
NOTE: To view graphs of these values, click the chart icons image:icon_chart_new_for_11_5.png[Chart Icon] in the Available columns.
+
image:nodes_page_storage_tables.png[Object stores tables]
...
image:forecast-metadata-usage.png[Forecast of metadata usage by site]