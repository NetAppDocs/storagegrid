...
---
= Edit alert rules in StorageGRID
:icons: font
:imagesdir: ../media/
...
+
image:alert_rules_edit_rule.png[Alerts > Edit Rule]
...
+
image:alert_rules_edit_revert_to_default.png[Alert rules: reverting an edited condition to default value]
+
