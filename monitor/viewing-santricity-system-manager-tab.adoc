...
---
= View the StorageGRID SANtricity System Manager tab
:icons: font
:imagesdir: ../media/
...
+
NOTE: To use SANtricity System Manager to configure a proxy for E-Series AutoSupport, see link:sending-eseries-autosupport-messages-through-storagegrid.html[Send E-Series AutoSupport packages through StorageGRID].
...
image:nodes_page_santricity_tab.png[Nodes page SANtricity tab]
