...
+
image:nodes_page_hardware_tab_for_appliance.png[Nodes Page Hardware Tab for Appliance]
+
...
+
image:nodes_page_network_communication.png[Nodes Page Network Comm]
...
+
image:nodes_page_storage_tables.png[Nodes Page Storage Tables]
...
+
image:nodes_page_hardware_tab_services_appliance.png[Nodes page Hardware tab for services appliance]
+
[cols="1a,2a" options="header"]
|===
| Field in the Appliance table| Description
...
.. Review the Network Interfaces section.
+
image:nodes_page_hardware_tab_network_services_appliance.png[Nodes Page Hardware Tab Network Services Appliance]
+
...
+
image:nodes_page_storage_tab_services_appliance.png[Nodes Page Storage Tab Services Appliance]
