...
+
image:grid_federation_connections_tab.png[Grid federation connections tab]
...
+
image:grid_federation_permitted_tenants_tab.png[Grid federation Permitted tenants tab]
