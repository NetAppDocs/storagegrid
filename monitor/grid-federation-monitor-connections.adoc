...
---
= Monitor StorageGRID grid federation connections
:icons: font
:imagesdir: ../media/
...
+
image:grid-federation-connections-tab.png[Grid federation connections tab]
...
+
image:grid-federation-permitted-tenants-tab.png[Grid federation Permitted tenants tab]
