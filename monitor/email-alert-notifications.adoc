...
+
Select the plus icon image:icon_plus_sign_black_on_white.gif[plus icon] to add recipients.
...
You can copy and paste the contents into this field, or select *Browse* and select the file.
+
NOTE: If you need to edit the email setup, select the pencil icon image:icon_edit_tm.png[Edit icon] to update this field.
...
image:alerts_email_notification.png[Alerts Email Notification]
