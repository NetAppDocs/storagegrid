...
If the *Email notification failure* alert is triggered or you are unable to receive the test email server notification, follow these steps to resolve the issue.
