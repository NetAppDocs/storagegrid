...
---
= View the StorageGRID Overview tab
:icons: font
:imagesdir: ../media/
...
image:nodes_page_overview_tab.png[Nodes Page Overview Tab]
...
* *IP addresses*: The node's IP addresses. Select *Show additional IP addresses* to view the node's IPv4 and IPv6 addresses and interface mappings.
...
image:nodes_page_alerts_table.png[Nodes Page Alerts Table]
