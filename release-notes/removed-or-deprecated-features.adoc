...
sidebar: sidebar
keywords:
summary: "StorageGRID 12.0 removes Swift API support, NFS audit export, and several previously deprecated operating system versions. Before you upgrade, check whether any removed or deprecated features affect your client applications or grid configuration."
---
...
[.lead]
StorageGRID 12.0 removes Swift API support, NFS audit export, and several previously deprecated operating system versions. Before you upgrade, check whether any removed or deprecated features affect your client applications or grid configuration.
