...
sidebar: sidebar
keywords:
summary: "Learn about features and capabilities that have been removed or deprecated in StorageGRID 12.1.0. Before you upgrade, check whether any removed or deprecated features affect your client applications or grid configuration."
---
= Removed or deprecated features and capabilities in StorageGRID
:icons: font
:imagesdir: ../media/

[.lead]
Learn about features and capabilities that have been removed or deprecated in StorageGRID 12.1.0. Before you upgrade, check whether any removed or deprecated features affect your client applications or grid configuration.

== Definitions

Deprecated:: You *should not* use the feature in new production environments. Existing production environments can continue using the feature.
...
| Global SSE setting for AES-128 encryption
| 12.1
| 12.2
| 12.3 
| Beginning with StorageGRID 12.1.0, support for AES-128 encryption of new objects stored at data at rest is deprecated. Support continues for retrieval of stored objects that were originally encrypted with AES-128.

| Alarms, legacy (_not Alerts_)
| 11.7
| 11.8
| 11.9
...
. Decommission all Archive Nodes. Refer to https://docs.netapp.com/us-en/storagegrid-118/maintain/grid-node-decommissioning.html[Grid node decommissioning (StorageGRID 11.8 doc site)^].
. Remove all Archive Node references from storage pools and ILM policies. Refer to https://kb.netapp.com/hybrid/StorageGRID/Maintenance/StorageGRID_11.9_software_upgrade_resolution_guide[NetApp Knowledge Base: StorageGRID 11.9 software upgrade resolution guide^].
...
| 12.0
| 12.1
| https://docs.netapp.com/us-en/storagegrid-118/monitor/managing-alarms.html#configure-notifications-for-alarms-legacy-system[Configure notifications for alarms (legacy system) (StorageGRID 11.8)^]
