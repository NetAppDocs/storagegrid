...
| 12.2
| 12.3 
| Beginning with StorageGRID 12.1.0, support for AES-128 encryption of new stored object data at rest is deprecated. Support continues for retrieval of stored objects that were originally encrypted with AES-128.
