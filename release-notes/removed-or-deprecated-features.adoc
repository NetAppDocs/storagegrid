...
[.lead]
Learn about features and capabilities that have been removed or deprecated in StorageGRID 12.0. Before you upgrade, check whether any removed or deprecated features affect your client applications or grid configuration.
...
| 12.2
| 12.3 
| Beginning with StorageGRID 12.1.0. support for AES-128 encryption of new objects stored at data at rest is deprecated. Support continues for retrieval of objects stored with AES-128 encryption in StorageGRID 12.0 and earlier.
