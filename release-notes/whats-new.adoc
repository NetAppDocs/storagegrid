...
summary: "StorageGRID 12.0 expands object storage capacity, improves AI/ML workload support, strengthens grid federation, simplifies system management, and enhances security across the platform."
---
...
Refer to link:../upgrade/performing-upgrade.html#upgrade-other-nodes[Upgrade other nodes].
...
* link:../admin/manage-external-ssh-access.html[SSH is blocked by default] to enhance security while allowing controlled access.
