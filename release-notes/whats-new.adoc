...
summary: "StorageGRID 12.0 expands object storage capacity, improves AIML workload support, strengthens grid federation, simplifies system management, and enhances security across the platform."
---
