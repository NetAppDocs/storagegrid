...
---
= Add to or change subnet lists on Admin Network in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_aesl_sample_input.gif[change ip tool aesl example]
--
...
+
image:change_ip_tool_aesl_sample_output.png[screenshot described by surrounding text]
