...
+
NOTE: If you are unable to log in to the grid node, the system disk might not be intact. Go to the procedure for  link:reviewing-warnings-for-system-drive-recovery.html[recovering from a system drive failure].
