...
---
= Perform additional StorageGRID node recovery steps
:icons: font
:imagesdir: ../media/
...
* link:selecting-start-recovery-to-configure-non-primary-admin-node.html[Recover the primary Admin Node using a non-primary Admin Node]
