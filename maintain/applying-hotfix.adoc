...
+
image:software_update_landing.png[Software Update Landing Page]

. Select *Apply hotfix*.
+
The StorageGRID Hotfix page appears.
+
image:hotfix_choose_file.png[Hotfix Choose File]
...
+
image:hotfix_progress_table.png[Hotfix Progress Table]
...
+
image:approve_all_progresstable.png[Hotfix progress with remove button]
