...
* If you are recovering a grid node other than the primary Admin Node, there is connectivity between the grid node being recovered and the Admin Node managing the recovery procedure.
...
// 2025 NOV 18, storagegrid-issues-40