...
---
= Identify and unmount failed storage volumes in StorageGRID
:icons: font
:imagesdir: ../media/
...
.. Scroll down to locate the Volumes table and Object stores table and record the following information for each volume with a status of Unknown or Offline.
+
