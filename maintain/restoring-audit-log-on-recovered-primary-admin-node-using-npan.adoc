...
summary: 'Restore the audit log on the recovered primary Admin Node by using a non-primary Admin Node.'
---
= Restore the StorageGRID audit log on a recovered primary Admin Node
:icons: font
:imagesdir: ../media/
