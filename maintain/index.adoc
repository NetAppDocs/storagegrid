...
NOTE: In these instructions, "Linux" refers to a Red Hat® Enterprise Linux® (RHEL), Ubuntu®, or Debian® deployment. For a list of supported versions, see the https://imt.netapp.com/matrix/#welcome[NetApp Interoperability Matrix Tool^].
