...
---
= Add trunk or access interfaces to a Linux node in StorageGRID
:icons: font
:imagesdir: ../media/
...
* You have access to the link:../swnodes/index.html[instructions for installing StorageGRID] on your Linux platform.
