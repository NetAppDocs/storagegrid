---
permalink: maintain/replace-primary-admin-node.html
sidebar: sidebar
...
---
= Replace primary StorageGRID Admin Node
:icons: font
:imagesdir: ../media/
...
You can replace a failed primary Admin Node with a primary Admin Node running on the same platform, or you can replace a primary Admin Node running on VMware or a Linux host with a primary Admin Node hosted on a services appliance. You can also replace a primary Admin Node running on VMware host with an SG1000 or SG100 service appliance.
...
link:replace-vmware-node-with-sg1000-sg100.html[Replace a VMware node with SG1000 or SG100]
