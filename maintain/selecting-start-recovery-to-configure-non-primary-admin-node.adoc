...
---
= Select Start Recovery to configure non-primary StorageGRID Admin Node
:icons: font
:imagesdir: ../media/
...
+
NOTE: To configure a relying party trust, refer to configure SSO using link:../admin/configure-sso-saml.html[SAML] or link:../admin/learn-about-setting-up-sso-oidc.html[OIDC]. To access the default server certificate, log in to the command shell of the Admin Node. Go to the `/var/local/mgmt-api` directory, and select the `server.crt` file.
