...
---
= Remount and reformat StorageGRID storage volumes (manual steps)
:icons: font
:imagesdir: ../media/
...
* In most cases, you should link:../maintain/restoring-object-data-to-storage-volume.html[restore object data using Grid Manager]. Answer `y` to use the Grid Manager.
