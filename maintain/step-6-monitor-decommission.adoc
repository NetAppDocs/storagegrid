...
---
= Monitor site decommission progress in StorageGRID
:icons: font
:imagesdir: ../media/
...
+
image:decommission_site_step_6_recovery_package.png[Site Decommission Step 6 recovery package]
+
...
+
image:decommission_site_step_6_data_movement.png[Decommission Site Step 6 Data Movement]
...
+
image:decommission_site_step_6_storage_node.png[Decommission Site Step 6 Storage Node]
+
...
+
image:decommission_site_step_6_repair_cassandra.png[Decommission Site Step 6 Repair Cassandra]
...
+
image:decommission_site_step_6_remove_configuration.png[Decommission Site Step 6 Remove Configuration]
...
+
image:decommission_site_success_message.png[Decommission Site Success Message]
