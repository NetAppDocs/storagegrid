...
. To remove any items you don't want to rename, select image:icon_x_to_remove.png[X icon] in the *Remove from list* column.
+
...
. Select image:icon_x_to_remove.png[X icon] to remove any items that you don't want to rename with this tool. 
+
For example, suppose you want to rename all nodes that contain the string `Data-Center-1`, but you don't want to rename the `Data-Center-1` site itself.  Select image:icon_x_to_remove.png[X icon] to remove the site from the rename preview.
+
...
. Make any additional changes required, or select image:icon_x_to_remove.png[X icon] to remove any items that you don't want to rename.
...
.. Copy each item's original system name and paste it into the *Display name* field, or select image:icon_x_to_remove.png[X icon] to remove any items you don't want to revert.
+
...
.. Confirm that each entry in the *Display name* field matches the name in the *System name* field. Make any changes or select image:icon_x_to_remove.png[X icon] to remove any items that you don't want to revert.
+
To revert a display name, the system name must appear in the *Display name* field, but the name is case insensitive.
