...
---
= Modify DNS configuration for single StorageGRID node
:icons: font
:imagesdir: ../media/
...
. If you've allowed external SSH access, link:../admin/manage-external-ssh-access.html[block access] when you're finished modifying the DNS configuration.
