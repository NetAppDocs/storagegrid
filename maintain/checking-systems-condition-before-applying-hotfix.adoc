...
---
= Check system condition before applying a StorageGRID hotfix
:icons: font
:imagesdir: ../media/
...
+
Connected nodes have green check marks image:icon_alert_green_checkmark.png[icon alert green check mark] on the Nodes page.
