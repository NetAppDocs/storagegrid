...
sidebar: sidebar
keywords: storagegrid, audit log, primary admin node, non-primary admin node
summary: 'Use a non-primary Admin Node to copy audit logs from a failed primary Admin Node using a non-primary Admin Node.'
---
= Copy audit logs from failed primary Admin Node using a non-primary Admin Node
:icons: font
:imagesdir: ../media/
