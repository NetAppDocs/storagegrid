...
summary: 'The ADC quorum ensures that a minimum number of Administrative Domain Controller \(ADC\) services remain available at each site. StorageGRID can automatically move the ADC service during decommission when needed.'
---
...
[.lead]
The ADC quorum ensures that a minimum number of Administrative Domain Controller (ADC) services remain available at each site. StorageGRID can automatically move the ADC service during decommission when needed.
