...
---
= Recover failed storage volumes and rebuild Cassandra database in StorageGRID
:icons: font
:imagesdir: ../media/
...
.What's next?
After the storage volumes are reformatted and remounted and necessary Cassandra operations are complete, you can link:../maintain/restoring-object-data-to-storage-volume-where-system-drive-is-intact.html[restore object data using Grid Manager].