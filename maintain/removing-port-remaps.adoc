...
---
= Remove port remaps on StorageGRID appliances
:icons: font
:imagesdir: ../media/
...
. If you've allowed external SSH access, link:../admin/manage-external-ssh-access.html[block access] when you've finished removing port remaps.
