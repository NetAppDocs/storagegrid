---
permalink: maintain/selecting-start-recovery-to-configure-non-primary-admin-node-using-npan.html
sidebar: sidebar
keywords: storagegrid, start recovery, non-primary admin node
summary: 'Select Start Recovery to configure the non-primary Admin Node during primary Admin Node recovery.'
---
