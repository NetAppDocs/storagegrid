...
---
= Add to or change subnet lists on Grid Network in StorageGRID
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_gnsl_sample_input.gif[screenshot described by surrounding text]
--
...
+
image:change_ip_tool_gnsl_sample_output.gif[screenshot described by surrounding text]
...
. If you've allowed external SSH access, link:../admin/manage-external-ssh-access.html[block access] when you're finished adding to or changing the subnet lists.
