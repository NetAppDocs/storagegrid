...
. Log in to the primary Admin Node. If the primary Admin Node is unavailable, use the non-primary Admin Node, if one exists, and if it is designated as the Admin Node for the recovery procedure.
