...
+
image:recovery_reset_warning.gif[screenshot showing the reset recovery warning dialog box]
+
...
+
image:recovery_reset_button.gif[screenshot showing the stage "waiting for manual steps"]
