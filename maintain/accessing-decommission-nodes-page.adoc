...
| *Note*: Support for Archive Nodes has been removed. If you need to decommission an Archive Node, see https://docs.netapp.com/us-en/storagegrid-118/maintain/recovering-from-archive-node-failures.html[Recover from Archive Node failures (StorageGRID 11.8 doc site)^] 
|===