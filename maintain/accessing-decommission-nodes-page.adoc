...
+
image::../media/decommission_nodes_page_all_connected.png[Nodes can be decommissioned]
+
In this example, the Decommission Possible column indicates that you can't decommission any of the nodes. The first node is the primary Admin Node, and decommissioning isn't supported for this node type. The other three nodes are Storage Nodes, and decommissioning isn't possible because they're required for the ADC quorum.
+
image::../media/decommission_nodes_page_cannot_decommission.png[Nodes can't be decommissioned]
