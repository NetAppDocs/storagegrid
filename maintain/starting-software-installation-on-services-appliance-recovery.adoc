...
* If you are installing a Gateway Node or non-primary Admin Node, you know the IP address for either of the following Admin Nodes:
...
* If you are recovering a node while signed in to a non-primary Admin Node, you can specify that Admin Node's IP address.
