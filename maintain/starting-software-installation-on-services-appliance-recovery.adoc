...
* If you are installing a Gateway Node or non-primary Admin Node, you know the IP address of the non-primary Admin Node (if one is available) or the primary Admin Node for the StorageGRID grid.
