...
* If you are recovering a node by using a non-primary Admin Node, you can specify that Admin Node's IP address.
...
. To install a primary Admin Node:
 ...
 .. Select an appropriate mode in the Installation Mode section. If you select the Install a node or recover this node using current configuration method, follow the Install a node or recover this node using current configuration steps. If you select the Recover this node using a non-primary Admin Node method, follow the Recover this node using a non-primary Admin Node steps.
...
Install a node or recover this node using the current configuration steps.
--
...
.. Click *Browse* to upload the *Software Package* and *Checksum File* for StorageGRID software. The files are automatically uploaded after you select them.
...
--
.. In the non-primary Admin Node IP field, enter the grid network IP address of the non-primary Admin Node you want to use for the recovery, and click *Save*.
