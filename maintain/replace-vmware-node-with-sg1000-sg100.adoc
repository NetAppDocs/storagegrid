...
. link:https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/deploying-services-appliance-node.html#deploy-services-appliance-as-primary-admin-node[Deploy the SG1000 or SG100 services appliance^].
+
...
. [[download-recovery-package]]Download the recovery package from GRID Manager:
.. Select *Maintenance* > *Recovery package*.
