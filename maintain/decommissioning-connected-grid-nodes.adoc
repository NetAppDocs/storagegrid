...
---
= Decommission connected StorageGRID nodes
:icons: font
:imagesdir: ../media/
...
* All grid nodes have Normal (green) health image:icon_alert_green_checkmark.png[green check mark icon]. If you see one of these icons in the *Health* column, you must try to resolve the issue:
+
...
| image:icon_alarm_yellow_notice.gif[yellow square icon]
| Yellow
| Notice

| image:icon_alert_yellow_minor.png[light orange diamond icon]
| Light orange
| Minor

| image:icon_alert_orange_major.png[dark orange diamond icon]
| Dark orange
| Major

| image:icon_alert_red_critical.png[red x icon]
| Red
| Critical
|===
 ...
 ** *Linux*: You might want to detach the volumes and delete the node configuration files you created during installation. See link:../swnodes/index.html[Install StorageGRID on software-based nodes].
