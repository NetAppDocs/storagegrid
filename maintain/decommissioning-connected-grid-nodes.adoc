 ...
 ** *Linux*: You might want to detach the volumes and delete the node configuration files you created during installation. See link:../install-nodes/index.html[Install StorageGRID on software-based nodes].
