...
summary: 'Determine whether a hotfix is required while recovering a primary Admin Node by using a non-primary Admin Node.'
---
= Determine StorageGRID hotfix requirement for primary Admin Node
:icons: font
:imagesdir: ../media/
...
.Steps
 ...
 . On the Overview tab, note the versions displayed in the *Software Version* field.
