...
---
= Resolve node conflicts and start site decommission in StorageGRID
:icons: font
:imagesdir: ../media/
...
* All nodes in your StorageGRID system must be connected (image:icon_alert_green_checkmark.png[Icon Alert Green check mark]).
+
...
. Review the disconnected nodes section of Step 5 (Resolve Node Conflicts) to determine if any nodes in your StorageGRID system have a Connection State of Unknown (image:icon_alarm_blue_unknown.png[Icon Alarm Blue Unknown]) or Administratively Down (image:icon_alarm_gray_administratively_down.png[Icon Alarm Gray Administratively Down]).
+
image:decommission_site_step_5_disconnected_nodes.png[Decommission Site Step 5 Resolve Node Conflicts]
...
+
image:decommission_site_step_5_ha_groups.png[Decommission Site Step 5 HA Groups]
...
+
image:decommission_site_step_5_provision_passphrase.png[Decommission Site Step 5 Provision Passphrase]
...
+
image:decommission_site_step_5_warning.png[Decommission Site Step 5 Warning]
...
+
image:decommission_site_step_5_grid_configuration.png[Decommission Site Step 5 Grid Configuration]
+
