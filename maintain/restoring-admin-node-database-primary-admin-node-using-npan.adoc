...
summary: 'Restore the Admin Node database when recovering a primary Admin Node by using a non-primary Admin Node.'
---
= Restore the StorageGRID Admin Node database when recovering the primary Admin Node
:icons: font
:imagesdir: ../media/
