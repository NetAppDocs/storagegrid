...
See the link:../swnodes/index.html[RHEL, Ubuntu, or Debian installation instructions] for more information about the location of the `/var/local` volume for a node.
