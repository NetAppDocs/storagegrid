...
To deploy new or reinstalled physical or virtual Linux hosts, follow the procedure for preparing the hosts in the StorageGRID installation instructions for your Linux operating system. See link:../swnodes/installing-linux.html[Install RHEL, Ubuntu, or Debian Linux].
