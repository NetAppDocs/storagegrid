...
** the IP address for the non-primary Admin Node, if one is available.
...
* You specify the IP address of the primary Admin Node. If the primary Admin Node is unavailable, you specify the IP address of the non-primary Admin Node, if it is available. You also confirm the hostname (system name) of the node.
