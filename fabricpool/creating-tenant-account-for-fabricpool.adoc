...
---
= Create a tenant account for FabricPool in StorageGRID
:icons: font
:imagesdir: ../media/
...
.. Optionally, select *Use grid federation connection* to allow the tenant to use a link:../admin/grid-federation-overview.html[grid federation connection] for account sync and cross-grid replication. Then, select the grid federation connection to use.
