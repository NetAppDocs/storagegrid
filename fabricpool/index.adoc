...
---
= Configuration workflow for using StorageGRID with FabricPool
:icons: font
:imagesdir: ../media/
...
[role="quick-margin-para"]
Optionally, configure link:../admin/using-identity-federation.html[identity federation] and link:../admin/how-sso-works.html[single sign-on].
...
//image:fabricpool_storagegrid_workflow.png[FabricPool StorageGRID Workflow]
